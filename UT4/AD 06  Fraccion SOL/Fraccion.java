...
{  
     ...
     * (Versión Javier Ruiz)
     */
    public boolean menorQueV2(Fraccion otra)
    {
        Fraccion division = this.dividir(otra);
        double valor = (double) division.getNumerador() /  division.getDenominador();
        return valor < 1;
    }
